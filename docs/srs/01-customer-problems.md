...
- S12 一期默认导入仅消费仓库中已登记的数据源，不从学号或预计毕业年份推断专业、年级、班级；默认培养方案导入只维护 `2024-default` 初始版本，后续正式版本仍由教师维护。
- S12/S13 的通知抓取、模板下载与短信投递收口统一遵循公开来源、结构化官方来源标识优先、草稿先行和 mock/local 兜底原则。
