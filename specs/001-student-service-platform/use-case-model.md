...
| 前置条件 | 学生完成身份认证并进入本人业务范围；证明说明、系统内置证明版式和审批角色已配置；若该证明属于学院可处理范围，系统已配置学院审批链 |
...
|------|--------|----------|
| 1 | 学生 | 进入“证明申请”页面 |
| 2 | 系统 | 展示证明类型、用途说明、必填字段、内置版式预览能力和附件要求 |
| 3 | 学生 | 填写用途、补充说明，并上传已有附件；当前阶段不提供完整 Word 模板字段映射选择 |
